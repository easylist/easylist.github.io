...
`View EasyList Germany <https://easylist.to/easylistgermany/easylistgermany.txt>`_ or `add it to your ad blocker <abp:subscribe?location=https://easylist.to/easylistgermany/easylistgermany.txt&title=EasyList%20Germany&requiresLocation=https://easylist.to/easylist/easylist.txt&requiresTitle=EasyList>`__
